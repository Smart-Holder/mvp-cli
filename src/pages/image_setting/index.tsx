...
class ImageSetting extends NavPage<{ address: string }> {
	...
	render() {
		...
		return <div className="image_page">
			<Header title={t("轮播图")} page={this} />

			<div className="setting_box">
				<div className="device_set_carousel_body">
					<SetCarousel time={time} page={this} mode='normal' address={this.params.address} screenWidth={screenWidth} screenHeight={screenHeight} />
...
export default withTranslation('translations', { withRef: true })(ImageSetting);
