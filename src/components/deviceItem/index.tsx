...
export const DeviceItem = (props: IDeviceItemProps) => {
	...
	return (
		<div className={`device_item  ${showActionBtn && "device_info_box"}`} onClick={onClick && onClick}>
			{/* {showArrow && <img className="right_arrow" src={require("../../assets/right_arrow.png")} alt=">" />} */}
			<div className={`device_desc_box`}>
				<div className="desc_box">
					<div className="top_part">
						<div className="left_box">
							<img src={[-1, 3].includes(deviceInfo.screen) ? require("../../assets/device2.png") : require("../../assets/device1.png")} alt="" />
						</div>
						<div className="right_box">
							...
							<div className="address_box">
								...
								>
									{getSubStr(deviceInfo.address, 10)}
								</div>
							</div>
						</div>
					</div>

					<div className="arrow_box">{showArrow && <img className="right_arrow" src={require("../../assets/right_arrow.png")} alt=">" />}</div>
				</div>
			...
			{showActionBtn && (
				<div className="action_btn_box">
					<Button loading={loading} ghost className="unbind_btn" onClick={unbind_device}>
						{t("解绑设备")}
					</Button>
					<Button disabled={loading} type="primary" className="setting_btn" onClick={onOk}>
						{t("设置")}
					</Button>
				</div>
			)}
